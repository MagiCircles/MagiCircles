...
def generateStylesheets(name=None, settings={}):
    ...
    magi_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', '..') # the base path for this package
...
@import "{magi_path}/static/less/main.less";
@import "{magi_path}/static/less/mixins/magicircles.less";
...
{extra}
    """.format(less=less, extra=extra_prod, magi_path=magi_path)
