...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='image',
            field=models.ImageField(default='', upload_to=web.utils.uploadItem(b'badges/'), verbose_name='Image'),
        ...
        migrations.AlterField(
            model_name='activity',
            name='image',
            field=models.ImageField(help_text='Only post official artworks, artworks you own, or fan artworks that are approved by the artist and credited.', upload_to=web.utils.uploadToRandom(b'activities/'), null=True, verbose_name='Image', blank=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='badge',
            name='image',
            field=models.ImageField(upload_to=web.utils.uploadItem(b'badges/'), verbose_name='Image'),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='badge',
        ...
        migrations.AlterField(
            ...
            name='image',
            field=models.ImageField(null=True, upload_to=web.utils.uploadItem(b'notifications/'), blank=True),
            preserve_default=True,
        ),
    ]
